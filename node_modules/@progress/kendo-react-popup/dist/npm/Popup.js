...
var Popup = /** @class */ (function (_super) {
    ...
    function Popup(props) {
        ...
        _this.position = function (settings, anchorElement, element) {
        ...
        _this._appendTo = document ? document.body : null;
    ...
    Popup.prototype.componentWillReceiveProps = function (nextProps) {
        this.getDomElements(nextProps);
        this._exitingAnimation = nextProps.animate && this.props.show && !nextProps.show;
    };
    /**
     * @hidden
     */
    Popup.prototype.componentWillMount = function () {
        this.getDomElements(this.props);
    };
    /**
     * @hidden
     */
    ...
    Popup.prototype.render = function () {
        var _a = this.props, animate = _a.animate, children = _a.children, className = _a.className, popupClass = _a.popupClass, show = _a.show, id = _a.id;
        if (show) {
        ...
        if ((show || this._exitingAnimation) && this._appendTo) {
            ...
            return ReactDOM.createPortal(popup, this._appendTo);
        }
        return null;
    };
    Popup.prototype.calculatePosition = function (anchorElement, props) {
        ...
        this._appendTo.appendChild(root);
    ...
    Popup.prototype.attachRepositionHandlers = function (element) {
        var _this = this;
        this.detachRepositionHandlers();
        this._scrollableParents = this._domService.scrollableParents(this._anchorElement || element);
    ...
    Popup.prototype.getDomElements = function (props) {
        this._appendTo = getHtmlElement(props.appendTo) || (document ? document.body : null);
        this._anchorElement = getHtmlElement(props.anchor);
    };
    /**
     * @hidden
     */
    Popup.propTypes = {
        anchor: function (props) {
            ...
            if (anchor && (typeof anchor.nodeType !== 'number' && !anchor.isReactComponent)) {
        ...
        appendTo: function (props) {
            ...
            if (element && (typeof element.nodeType !== 'number' && !element.isReactComponent)) {
