...
import ComboBoxBase from '../common/ComboBoxBase';
import { itemIndexStartsWith, getItemText, getText, getItemIndexByText } from '../common/util';
...
var AutoComplete = /** @class */ (function (_super) {
    ...
    function AutoComplete(props) {
        ...
        _this.handleItemSelect = function (index, state) {
            var newText = getText(_this.props, index);
        ...
        var dropdown = new DropDownBase(_this);
        _this.combobox = new ComboBoxBase(dropdown);
    ...
    AutoComplete.prototype.render = function () {
        ...
        var dropdown = this.combobox.dropdown;
        var autoComplete = (React.createElement("span", { className: classNames('k-widget k-autocomplete k-header', className, { 'k-state-disabled': disabled, 'k-state-focused': isFocused && !disabled }), ref: function (element) {
        ...
        return label
            ? (React.createElement(FloatingLabel, { label: label, value: value, style: { width: style ? style.width : undefined }, id: this._inputId, children: autoComplete }))
            : autoComplete;
    };
    /**
     * @hidden
    ...
    AutoComplete.prototype.applyInputValue = function (value, state, eventKey) {
        ...
        if (opened && eventKey === 13 /* enter */) {
            var newValue = getText(this.props, focusedIndex);
    ...
    AutoComplete.prototype.getFocusedIndex = function (value, data) {
        ...
        return selectedIndex !== -1 ? selectedIndex : itemIndexStartsWith(value, data, textField);
    };
    ...
    AutoComplete.prototype.renderListContainer = function () {
        ...
        var opened = this.state.opened;
        return (React.createElement(ListContainer, { onMouseDown: function () {
    ...
    AutoComplete.prototype.renderList = function () {
        ...
        var value = this.value;
        return (React.createElement(List, { id: dropdown.listBoxId, show: opened, data: data.slice(), focusedIndex: focusedIndex, value: value, textField: textField, valueField: textField, highlightSelected: false, optionPrefix: dropdown.optionPrefix, listRef: function (element) {
    ...
    AutoComplete.prototype.suggestValue = function (value) {
        ...
        if (value) {
            ...
            var suggestedItem = data[itemIndexStartsWith(value, data, textField)];
            if (suggestedItem) {
                var suggestedText = getItemText(suggestedItem, textField);
     ...
     * @hidden
     */
    AutoComplete.propTypes = __assign({}, DropDownBase.basicPropTypes, { suggest: PropTypes.oneOfType([PropTypes.bool, PropTypes.string]), placeholder: PropTypes.string, value: PropTypes.string, defaultValue: PropTypes.string, readonly: PropTypes.bool });
    /**
     * @hidden
     */
    AutoComplete.defaultProps = __assign({}, ComboBoxBase.defaultProps);
    return AutoComplete;
}(React.Component));
