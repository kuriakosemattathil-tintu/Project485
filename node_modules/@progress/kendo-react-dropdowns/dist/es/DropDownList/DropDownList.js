...
import { classNames, FloatingLabel } from '@progress/kendo-react-common';
...
var DropDownList = /** @class */ (function (_super) {
    ...
    function DropDownList(props) {
        ...
        _this.renderDropDownWrapper = function () {
            ...
            if (!isPresent(value) && defaultItem !== undefined) {
                value = getItemValue(defaultItem, valueField);
                text = getItemText(defaultItem, textField);
            }
        ...
        _this.renderListFilter = function () {
            ...
            return filterable && (React.createElement(ListFilter, { value: filterText, focused: opened && filterInputFocused, willFocus: _this.filteringInputWillFocus, didFocus: _this.filteringInputDidFocus, onChange: _this.handleListFilterChange, onKeyDown: _this.base.handleKeyDown }));
        };
        _this.renderDefaultItem = function () {
            var _a = _this.props, textField = _a.textField, defaultItem = _a.defaultItem;
            return defaultItem && (React.createElement(ListDefaultItem, { defaultItem: defaultItem, textField: textField, selected: _this.index === -1, key: defaultItemKey, onClick: _this.handleDefaultItemClick }));
        };
        ...
        _this.selectNext = function (event) {
            ...
            for (; index < dataLength; index++) {
                text = getter(data[index].item, textField);
        ...
        var selected = -1;
        var text = '';
        if (!isPresent(value) && isPresent(props.defaultItem)) {
            value = getItemValue(props.defaultItem, props.valueField);
            text = getItemText(props.defaultItem, props.textField);
        }
        else {
            selected = getItemIndex(props, value);
            text = getItemText((props.data || [])[selected], props.textField);
        }
    ...
    DropDownList.prototype.render = function () {
        ...
        var text = getText(this.props, getItemIndex(this.props, this.value));
        var dropdownlist = (React.createElement("span", { ref: function (dropdown) { _this._element = dropdown; }, className: classNames('k-widget k-dropdown k-header', className), style: !label
                ? style
                : __assign({}, style, { width: undefined }), dir: dir, onMouseDown: opened ? preventDefault : undefined },
            this.renderDropDownWrapper(),
            this.renderListContainer()));
        return label
            ? (React.createElement(FloatingLabel, { label: label, value: text, style: { width: style ? style.width : undefined }, children: dropdownlist }))
            : dropdownlist;
    };
    /**
     * @hidden
     */
    DropDownList.propTypes = __assign({ delay: PropTypes.number, ignoreCase: PropTypes.bool, iconClassName: PropTypes.string, defaultItem: PropTypes.any, valueRender: PropTypes.func }, DropDownBase.propTypes);
    /**
     * @hidden
     */
