...
var DropDownWrapper = /** @class */ (function (_super) {
    ...
    DropDownWrapper.prototype.render = function () {
        ...
        return (React.createElement("span", { role: 'listbox', tabIndex: disabled ? undefined : tabIndex, className: kendo_react_common_1.classNames('k-dropdown-wrap', this.props.className, {
