...
var ListDefaultItem = /** @class */ (function (_super) {
    ...
    ListDefaultItem.prototype.render = function () {
        ...
        return (React.createElement("div", { onClick: this.onClick, onMouseDown: this.onMouseDown, className: kendo_react_common_1.classNames('k-list-optionlabel', {
                'k-state-selected': selected
            }) }, util_1.getter(defaultItem, textField) || ''));
    };
